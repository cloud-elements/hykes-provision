...
function create() {
  ../../bin/hykes-provision create digitalocean --consolidated --dns=hosts --specs=xsmall
}

function destroy() {
  ../../bin/hykes-provision destroy digitalocean --consolidated --dns=hosts
}
...
@test 'create should setup consolidated digitalocean servers and /etc/hosts dns' {
...
@test 'destroy should teardown consolidated digitalocean servers and /etc/hosts dns' {
